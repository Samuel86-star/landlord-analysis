...
SELECT
    ...
    ROUND(COUNT(CASE WHEN r.result_id = 1 THEN 1 END) * 100.0 / NULLIF(COUNT(*), 0), 2) AS win_rate,
    ROUND(COUNT(CASE WHEN r.result_id = 2 THEN 1 END) * 100.0 / NULLIF(COUNT(*), 0), 2) AS lose_rate,
