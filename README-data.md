...
| `dws_ddz_app_game_stat` | [dws_ddz_app_game_stat.md](dws/dws_ddz_app_game_stat.md) | APP端每日游戏行为统计表 |
| `dws_dq_app_daily_reg` | [dws_dq_app_daily_reg.md](dws/dws_dq_app_daily_reg.md) | APP端每日注册用户宽表 |
| `dws_app_game_active` | [dws_app_game_active.md](dws/dws_app_game_active.md) | 每日游戏活跃用户表（整体留存 flag 用） |
| `dws_app_gamemode_active` | [dws_app_gamemode_active.md](dws/dws_app_gamemode_active.md) | 每日游戏活跃用户×玩法表（同玩法留存 flag 用） |
