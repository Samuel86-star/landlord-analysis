...
- **0 行警告**：行数为 0 的表打 `⚠️ WARNING` 并汇总到结尾，需人工确认（见 [troubleshooting.md](../ops/troubleshooting.md)）
...
| 症状 | 排查 |
| ---- | ---- |
| 脚本报 OK 但目标表 0 行 | strict mode 静默回滚，看 [troubleshooting.md](../ops/troubleshooting.md) 第 1 节 |
...
- [ops/troubleshooting.md](../ops/troubleshooting.md) — strict mode 静默回滚等疑难问题排查
