...
> **口径更正（2026-09-07）**：本框架先过滤 `play_mode BETWEEN 1 AND 6`，再选择 4484/12074，因此“首次”不是注册后真实首局，而是过滤后首次进入目标子集。该历史框架不再用于注册首局分析；新口径见[注册后真实前三局定义](../registered-first-ddz-first3-definition.md)。
