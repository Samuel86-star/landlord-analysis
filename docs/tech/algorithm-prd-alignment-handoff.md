...
> 交接日期 2026-07-31。本文件仅保留历史背景；2026-09-10 起算法已迁入本仓直接维护，治理规则见 [`algorithm/README.md`](../../algorithm/README.md)。
...
原“源仓库未同步”事项已完成：修复曾按 `71599ad..e4be61a` 的差异清单同步；2026-09-10 起后续改动直接提交到本仓 `algorithm/`。
